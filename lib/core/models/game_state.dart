...
class GameState extends GetxController {
  ...
  bool _hasThreeInARow(Player player) {
    if (fields.elementAt(0) == player &&
            fields.elementAt(1) == player &&
            fields.elementAt(2) == player ||
        fields.elementAt(3) == player &&
            fields.elementAt(4) == player &&
            fields.elementAt(5) == player ||
        fields.elementAt(6) == player &&
            fields.elementAt(7) == player &&
            fields.elementAt(8) == player ||
        fields.elementAt(0) == player &&
            fields.elementAt(3) == player &&
            fields.elementAt(6) == player ||
        fields.elementAt(1) == player &&
            fields.elementAt(4) == player &&
